...
const Hero = () => {
  return (
    <div
      className="relative w-full h-[110vh] sm:h-screen bg-[#1A1A1A] flex flex-col justify-center items-center text-center px-4"
      style={{
    ...
    >
      ...
      <p className="text-gray-300 max-w-3xl leading-relaxed text-base sm:text-lg px-10">
